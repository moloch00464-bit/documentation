#!/usr/bin/env python3
"""
M.O.L.O.C.H. 3.0 - Raspberry Pi Edition
========================================
Optimized for Raspberry Pi 5 with Vosk + Piper!
"""
...
# RPi: Use Vosk instead of termux-speech-to-text
from voice_rpi import VoiceRPi as VoiceIO
...
def main():
    ...
    Vosk (Offline) + Piper TTS + Claude Vision
    """)
