...
# MolochGuckMal - Screenshot Analyse (HOMESCREEN-FREUNDLICH!)
...
# Screenshot + Analyse, Antwort speichern
ANTWORT_FILE="/tmp/moloch_screenshot_$$.txt"
python moloch.py -s > "$ANTWORT_FILE" 2>&1
